...
cmd_e_fill_rgb(SIDES, 1,68*interval,0, 0,0,255)		# bright blue when first raindrop lands

for rain in range(25):
  wait_for_tick(rain*21*interval)
  cmd_e_shift_down(DIAGS,  3, rain*21*interval, interval, 1, 0,0,255, 0)			# blue
...
for rain in range(15):
  wait_for_tick(rain*21*interval)
  cmd_e_shift_down(DIAGS,  6, rain*21*interval, interval, 1, 0,0,255, 0)			# blue
