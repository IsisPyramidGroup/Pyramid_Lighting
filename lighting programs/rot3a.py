# Rotation variant 2, second and subsequent iterations
...
# starting position: front left diagonal and bottom left of the door are red.
# also, back right diagonal and pixels leading up to it are green.
#Else black.
...
#cmd_e_fill_rgb(E_DIAG_4|E_DIAG_5, 1,0,0, 0,255,0)
#cmd_e_fill_rgb(E_BACK,  1,0,0, 0,255,0)
#cmd_e_shift_up(E_BACK,  1,0,0, 96-24, 0,0,0, 0)
...
# and the green
cmd_e_shift_up(E_BACK, 24,0,1, 1, 0,0,0, 0)
cmd_e_shift_up(E_RIGHT, 72,0,1, 1, 0,255,0, 0)
...
for slider in range(0,10):
  ...
  cmd_e_fill_rgb(E_DIAG_4|E_DIAG_5, 1,0,0, 0,dimming(slider),0)
  cmd_e_fill_rgb(E_DIAG_6|E_DIAG_7, 1,0,0, 0,brightening(slider),0)
  wait(4)
wait(8)
...
cmd_e_shift_up(E_FRONT, 72,0,1, 1, 0,255,0, 0)
...
for slider in range(0,10):
  ...
  cmd_e_fill_rgb(E_DIAG_0|E_DIAG_1, 1,0,0, 0,dimming(slider),0)
  cmd_e_fill_rgb(E_DIAG_2|E_DIAG_3, 1,0,0, 0,brightening(slider),0)
  wait(4)
wait(8)
...
cmd_e_shift_up(E_BACK,  72,0,1, 1, 0,255,0, 0)
...
for slider in range(0,10):
  ...
  cmd_e_fill_rgb(E_DIAG_2|E_DIAG_3, 1,0,0, 0,dimming(slider),0)
  cmd_e_fill_rgb(E_DIAG_4|E_DIAG_5, 1,0,0, 0,brightening(slider),0)
  wait(4)
wait(8)

# the front is now 3/4 full of red, start shifting in black now
cmd_e_shift_up(E_FRONT, 72,0,1, 1, 0,0,0, 0)
cmd_e_shift_up(E_BACK,  72,0,1, 1, 0,0,0, 0)
